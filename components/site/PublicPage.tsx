  ...
  return (
    <div className={className}>
      ...
      <header className="cms-header">
        ...
        <div className="cms-actions"><a className="cms-register" href="https://register.necypaact.com/en/register">Register</a><a className="cms-hotel" href="https://www.necypaact.com/hotel">Book a hotel room</a><button className="cms-menu-button" aria-expanded={menu} aria-controls="cms-mobile-menu" aria-label={menu ? "Close navigation" : "Open navigation"} onClick={() => setMenu((value) => !value)} type="button">{menu ? <X aria-hidden="true" /> : <Menu aria-hidden="true" />}</button></div>
        {menu ? <nav className="cms-mobile-menu" id="cms-mobile-menu" aria-label="Mobile navigation"><a href="#about" onClick={() => setMenu(false)}>About</a><a href="#business-meeting" onClick={() => setMenu(false)}>Meetings</a><a href="#events" onClick={() => setMenu(false)}>Events</a><a href="#ypaa" onClick={() => setMenu(false)}>YPAA near you</a></nav> : null}
      </header>
