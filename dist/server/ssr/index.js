...
var client_references_default = {
	"0b6734e15122": async () => {
		const m = await import("./assets/Button-B7S5V5aU.js");
		return { get "Button"() {
			return m["Button"];
		} };
	},
	"11e5540e957d": async () => {
		const m = await import("./assets/HexColorField-BF4pQdQP.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"1259c181cc6d": async () => {
		const m = await import("./assets/LanguageSelector-BdMzHBq6.js");
		return { get "LanguageSelector"() {
			return m["LanguageSelector"];
		} };
	},
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-DHg_nxV9.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"16a3fa31eaec": async () => {
		const m = await import("./assets/Card-Be9YslqF.js");
		return { get "Card"() {
			return m["Card"];
		} };
	},
	"28814b6a7f22": async () => {
		const m = await import("./assets/Date-BL5nShf-.js");
		return { get "DateDiffComponent"() {
			return m["DateDiffComponent"];
		} };
	},
	"2c341ed2e5bc": async () => {
		const m = await import("./assets/ProgramBoard-Y_5dfuDz.js");
		return { get "ProgramBoard"() {
			return m["ProgramBoard"];
		} };
	},
	"30981185b63d": async () => {
		const m = await import("./assets/AdminRuntimeRecovery-CZ957Qxb.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"36b63adfbcd6": async () => {
		const m = await import("./assets/CreatedAtCell-C6NuTOql.js");
		return { get "VersionDrawerCreatedAtCell"() {
			return m["VersionDrawerCreatedAtCell"];
		} };
	},
	"381981ed701c": async () => {
		const m = await import("./assets/ID-1Qg9ewYv.js");
		return { get "IDCell"() {
			return m["IDCell"];
		} };
	},
	"3db04f5cf6c9": async () => {
		const m = await import("./assets/ProgramExplorer-gXc6Yfz3.js").then((n) => n.n);
		return { get "ProgramExplorer"() {
			return m["ProgramExplorer"];
		} };
	},
	"3fe31ae0c853": async () => {
		const m = await import("./assets/Row-B-SUvmzj.js");
		return { get "Row"() {
			return m["Row"];
		} };
	},
	"4072158f4658": async () => {
		const m = await import("./assets/Group-6KqGo3bf.js");
		return { get "Group"() {
			return m["Group"];
		} };
	},
	"486c98a1406c": async () => {
		const m = await import("./assets/PuckPageBuilderClient-DlK868Rb.js");
		return { get "PuckPageBuilderClient"() {
			return m["PuckPageBuilderClient"];
		} };
	},
	"4a7dd62f5d74": async () => {
		const m = await import("./assets/SettingsMenuButton-B1H6hVaf.js");
		return { get "SettingsMenuButton"() {
			return m["SettingsMenuButton"];
		} };
	},
	"4f6b44958a85": async () => {
		const m = await import("./assets/Collapsible-DJ1bmVqK.js");
		return { get "Collapsible"() {
			return m["Collapsible"];
		} };
	},
	"50d1309b9477": async () => {
		const m = await import("./assets/index.client-CtKOuE2j.js");
		return { get "APIViewClient"() {
			return m["APIViewClient"];
		} };
	},
	"53453b85c506": async () => {
		const m = await import("./assets/TabLink-D52MnePd.js");
		return { get "DocumentTabLink"() {
			return m["DocumentTabLink"];
		} };
	},
	"57b9351e68d9": async () => {
		const m = await import("./assets/index.client-CFMf1QTq.js");
		return { get "AccountClient"() {
			return m["AccountClient"];
		} };
	},
	"57f9b12b2bd1": async () => {
		const m = await import("./assets/index.client-iwdUzqbl.js");
		return { get "CreateFirstUserClient"() {
			return m["CreateFirstUserClient"];
		} };
	},
	"5861ef9d6a17": async () => {
		const m = await import("./assets/SiteFrame-5pF_eYdh.js");
		return { get "SiteFrame"() {
			return m["SiteFrame"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-CB5b5loR.js");
		return {
			get "ErrorBoundary"() {
	...
	"5a0a5013a7a9": async () => {
		const m = await import("./assets/Iterable-BXDhxlZI.js");
		return { get "Iterable"() {
			return m["Iterable"];
		} };
	},
	"5a3524688611": async () => {
		const m = await import("./assets/LogoutClient-Dgkyz9Gv.js");
		return { get "LogoutClient"() {
			return m["LogoutClient"];
		} };
	},
	"5ea69974cb56": async () => {
		const m = await import("./assets/index.client-76Xyhijh.js");
		return { get "DefaultNavClient"() {
			return m["DefaultNavClient"];
		} };
	},
	"5f0ed0c38c72": async () => {
		const m = await import("./assets/VersionPillLabel-CXc7Ozph.js");
		return { get "VersionPillLabel"() {
			return m["VersionPillLabel"];
		} };
	},
	"63e9c1549c8f": async () => {
		const m = await import("./assets/client-CJQLBaQM.js").then((n) => n.W);
		return {
			get "ActionsProvider"() {
				return m["ActionsProvider"];
			},
			get "AppHeader"() {
				return m["AppHeader"];
			},
			get "BulkUploadProvider"() {
				return m["BulkUploadProvider"];
			},
			get "Button"() {
				return m["Button"];
			},
			get "DefaultBrowseByFolderView"() {
				return m["DefaultBrowseByFolderView"];
			},
			get "DefaultCell"() {
				return m["DefaultCell"];
			},
			get "DefaultCollectionFolderView"() {
				return m["DefaultCollectionFolderView"];
			},
			get "DefaultListView"() {
				return m["DefaultListView"];
			},
			get "DocumentInfoProvider"() {
				return m["DocumentInfoProvider"];
			},
			get "EditDepthProvider"() {
				return m["EditDepthProvider"];
			},
			get "EntityVisibilityProvider"() {
				return m["EntityVisibilityProvider"];
			},
			...
			get "FolderFileTable"() {
				return m["FolderFileTable"];
			},
			get "GroupByHeader"() {
				return m["GroupByHeader"];
			},
			get "GroupByPageControls"() {
				return m["GroupByPageControls"];
			},
			get "Gutter"() {
				return m["Gutter"];
			},
			get "HydrateAuthProvider"() {
				return m["HydrateAuthProvider"];
			},
			get "ItemCardGrid"() {
				return m["ItemCardGrid"];
			},
			get "Link"() {
				return m["Link"];
			},
			get "ListQueryProvider"() {
				return m["ListQueryProvider"];
			},
			get "LivePreviewProvider"() {
				return m["LivePreviewProvider"];
			},
			get "Logout"() {
				return m["Logout"];
			},
			...
			get "OrderableTable"() {
				return m["OrderableTable"];
			},
			get "PageConfigProvider"() {
				return m["PageConfigProvider"];
			},
			get "Pill"() {
				return m["Pill"];
			},
			...
			get "RenderDefaultCell"() {
				return m["RenderDefaultCell"];
			},
			get "RenderTitle"() {
				return m["RenderTitle"];
			},
			get "RootProvider"() {
				return m["RootProvider"];
			},
			get "SelectAll"() {
				return m["SelectAll"];
			},
			...
			get "SelectionProvider"() {
				return m["SelectionProvider"];
			},
			get "SetDocumentStepNav"() {
				return m["SetDocumentStepNav"];
			},
			get "SetStepNav"() {
				return m["SetStepNav"];
			},
	...
	"69ffbf304cd0": async () => {
		const m = await import("./assets/Tabs-C2uNGbPd.js");
		return { get "Tabs"() {
			return m["Tabs"];
		} };
	},
	"6ee615f6c2ff": async () => {
		const m = await import("./assets/index.client-XLhpM_PO.js");
		return { get "ModularDashboardClient"() {
			return m["ModularDashboardClient"];
		} };
	},
	"6f80e8b30e2b": async () => {
		const m = await import("./assets/client-Dd-hh4YI.js").then((n) => n.r);
		return {
			get "AlignFeatureClient"() {
				return m["AlignFeatureClient"];
			},
			get "BlockquoteFeatureClient"() {
				return m["BlockquoteFeatureClient"];
			},
			get "BoldFeatureClient"() {
				return m["BoldFeatureClient"];
			},
			get "FixedToolbarFeatureClient"() {
				return m["FixedToolbarFeatureClient"];
			},
			get "HeadingFeatureClient"() {
				return m["HeadingFeatureClient"];
			},
			get "InlineToolbarFeatureClient"() {
				return m["InlineToolbarFeatureClient"];
			},
			get "ItalicFeatureClient"() {
				return m["ItalicFeatureClient"];
			},
			get "LinkFeatureClient"() {
				return m["LinkFeatureClient"];
			},
			get "OrderedListFeatureClient"() {
				return m["OrderedListFeatureClient"];
			},
			get "ParagraphFeatureClient"() {
				return m["ParagraphFeatureClient"];
			},
			get "RichTextField"() {
				return m["RichTextField"];
			},
			get "StrikethroughFeatureClient"() {
				return m["StrikethroughFeatureClient"];
			},
			get "UnderlineFeatureClient"() {
				return m["UnderlineFeatureClient"];
			},
			get "UnorderedListFeatureClient"() {
				return m["UnorderedListFeatureClient"];
			}
		};
	},
	"767f360946f8": async () => {
		const m = await import("./assets/ProductDetail-BclXE9MU.js");
		return { get "ProductDetail"() {
			return m["ProductDetail"];
		} };
	},
	"7ff7bb26029d": async () => {
		const m = await import("./assets/TenantThemeProvider-Dh5LQG_O.js").then((n) => n.t);
		return {
			get "TenantThemeProvider"() {
				return m["TenantThemeProvider"];
			},
			get "defaultTenantTheme"() {
				return m["defaultTenantTheme"];
			}
		};
	},
	"833032219a1a": async () => {
		const m = await import("./assets/ForgotPasswordForm-CSiccTbF.js");
		return { get "ForgotPasswordForm"() {
			return m["ForgotPasswordForm"];
		} };
	},
	"8476fbc98048": async () => {
		const m = await import("./assets/index.client-Cc4M-ltg.js");
		return { get "ToastAndRedirect"() {
			return m["ToastAndRedirect"];
		} };
	},
	"8801f96e4c55": async () => {
		const m = await import("./assets/RenderVersionFieldsToDiff-Dos6yiJO.js");
		return { get "RenderVersionFieldsToDiff"() {
			return m["RenderVersionFieldsToDiff"];
		} };
	},
	"886aedf60850": async () => {
		const m = await import("./assets/VersionsPill-CtrDJta3.js");
		return { get "VersionsPill"() {
			return m["VersionsPill"];
		} };
	},
	"8c0f216c4604": async () => {
	...
	"8f90f6baa39e": async () => {
		const m = await import("./assets/ProgramBoardNavLink-GnDOh74A.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"910b0e614a32": async () => {
		const m = await import("./assets/Default-BH3WHDnP.js");
		return { get "DefaultVersionView"() {
			return m["DefaultVersionView"];
		} };
	},
	"93c0935ff840": async () => {
		const m = await import("./assets/Text-2N9ld4Sj.js");
		return { get "Text"() {
			return m["Text"];
		} };
	},
	"98d851db76d0": async () => {
		const m = await import("./assets/RegistrationPortal-CIaw3xO8.js");
		return { get "RegistrationPortal"() {
			return m["RegistrationPortal"];
		} };
	},
	"9f4b211434d8": async () => {
		const m = await import("./assets/NavWrapper-4c9susQm.js");
		return { get "NavWrapper"() {
			return m["NavWrapper"];
		} };
	},
	"a2a0af3105d4": async () => {
		const m = await import("./assets/R2ClientUploadHandler-rIHL0sg0.js");
		return { get "R2ClientUploadHandler"() {
			return m["R2ClientUploadHandler"];
		} };
	},
	"a2b26419d214": async () => {
		const m = await import("./assets/NavHamburger-DlD_TsjW.js");
		return { get "NavHamburger"() {
			return m["NavHamburger"];
		} };
	},
	"a770902ae84c": async () => {
		const m = await import("./assets/frontend-styles-CnfetvX5.js");
		return { get "FrontendStyles"() {
			return m["FrontendStyles"];
		} };
	},
	"a85f130eb06a": async () => {
		const m = await import("./assets/Select-DH-Cm7sv.js");
		return { get "Select"() {
			return m["Select"];
		} };
	},
	"ade2709ca4b9": async () => {
		const m = await import("./assets/index.client-C-VrJDB2.js");
		return { get "NotFoundClient"() {
			return m["NotFoundClient"];
		} };
	},
	"afbba3addf9c": async () => {
		const m = await import("./assets/Wrapper-DhK-J-R2.js");
		return { get "Wrapper"() {
			return m["Wrapper"];
		} };
	},
	"b646b0735a0d": async () => {
		const m = await import("./assets/config-Z15zxwKW.js");
		return { get "PublicPuckRender"() {
			return m["PublicPuckRender"];
		} };
	},
	"b8413642c1c9": async () => {
		const m = await import("./assets/ShouldRenderTabs-BPOyzoFe.js");
		return { get "ShouldRenderTabs"() {
			return m["ShouldRenderTabs"];
		} };
	},
	"ba57fed24be2": async () => {
		const m = await import("./assets/ResetPreferences-CB8btbgm.js");
		return { get "ResetPreferences"() {
			return m["ResetPreferences"];
		} };
	},
	"be177131e27e": async () => {
		const m = await import("./assets/MerchandiseCatalog-Ds_8KYwn.js");
		return { get "MerchandiseCatalog"() {
			return m["MerchandiseCatalog"];
		} };
	},
	"c0051f3d55c3": async () => {
		const m = await import("./assets/NavHamburger-B1Jr94F3.js");
		return { get "NavHamburger"() {
			return m["NavHamburger"];
		} };
	},
	"c2747888630f": async () => {
		const m = await import("./assets/link-B4TgbXTk.js").then((n) => n.n);
		return { get "default"() {
			return m["default"];
		} };
	},
	"ca1499ffbb9c": async () => {
		const m = await import("./assets/ToggleTheme-BYLagS3A.js");
		return { get "ToggleTheme"() {
			return m["ToggleTheme"];
		} };
	},
	"dbfe655ba410": async () => {
		const m = await import("./assets/index.client-CNj4lVYA.js");
		return { get "VersionsViewClient"() {
			return m["VersionsViewClient"];
		} };
	},
	"e191409b4672": async () => {
		const m = await import("./assets/Locked-CFzNRcea.js");
		return { get "Locked"() {
			return m["Locked"];
		} };
	},
	"e2fa5362cc59": async () => {
		const m = await import("./assets/CartPage-BdFspWGS.js");
		return { get "CartPage"() {
			return m["CartPage"];
		} };
	},
	"e4e8c9c42a0c": async () => {
		const m = await import("./assets/ResetPasswordForm-BvPey5zH.js");
		return { get "ResetPasswordForm"() {
			return m["ResetPasswordForm"];
		} };
	},
	"e5b716a877d0": async () => {
		const m = await import("./assets/Edit-tmRDCo3C.js");
		return { get "EditView"() {
			return m["EditView"];
		} };
	},
	"ea80b929f660": async () => {
		const m = await import("./assets/AutosaveCell-CclSEqtp.js");
		return { get "AutosaveCell"() {
			return m["AutosaveCell"];
		} };
	},
	"ecc1fac0b8fd": async () => {
		const m = await import("./assets/CreatedAt-_UNRuc69.js");
		return { get "CreatedAtCell"() {
			return m["CreatedAtCell"];
		} };
	},
	"ecf03f510ba3": async () => {
		const m = await import("./assets/LoginForm-B7SF95lY.js");
		return { get "LoginForm"() {
			return m["LoginForm"];
		} };
	},
	"f1cce51f5a88": async () => {
		const m = await import("./assets/DeletePageButton-CKrSK_2O.js");
		return { get "default"() {
			return m["default"];
		} };
	},
	"f61f735f2a67": async () => {
		const m = await import("./assets/Banner-BP6pXVN0.js");
		return { get "Banner"() {
			return m["Banner"];
		} };
	}
...
//#endregion
export { __require as A, require_react as C, stripBasePath as D, hasBasePath as E, __commonJSMin as O, AppElementsWire as S, VINEXT_PARAMS_HEADER as T, toBrowserNavigationHref as _, getMountedSlotsHeader as a, assertSafeNavigationUrl as b, prefetchRscResponse as c, ReadonlyURLSearchParams as d, app_ssr_entry_default as default, createRscRequestHeaders as f, resolveRelativeHref as g, isHashOnlyBrowserUrlChange as h, handleSsr, getLayoutSegmentContext as i, __toESM as j, __exportAll as k, usePathname as l, notifyAppRouterTransitionStart as m, require_jsx_runtime as n, getPrefetchedUrls as o, createRscRequestUrl as p, getCurrentInterceptionContext as r, navigateClientSide as s, require_react_dom as t, useRouter as u, toSameOriginAppPath as v, VINEXT_MOUNTED_SLOTS_HEADER as w, isDangerousScheme as x, withBasePath as y };
