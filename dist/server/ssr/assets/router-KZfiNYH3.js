import { C as require_react, D as stripBasePath, _ as toBrowserNavigationHref, h as isHashOnlyBrowserUrlChange, j as __toESM, v as toSameOriginAppPath } from "../index.js";
import { a as urlQueryToSearchParams, i as appendSearchParamsToUrl, o as addLocalePrefix, r as addQueryParam, s as getDomainLocaleUrl } from "./link-B4TgbXTk.js";
...
async function navigateClient(url) {
	...
	try {
		...
		const React = (await import("../index.js").then((n) => /* @__PURE__ */ __toESM(n.C(), 1))).default;
		assertStillCurrent();
