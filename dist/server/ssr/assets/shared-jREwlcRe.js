...
import { Rt as stringify } from "./client-CJQLBaQM.js";
import { t as enUS } from "./en-US-BnXdOesP.js";
import { a as millisecondsInDay, i as constructFrom, n as normalizeDates, o as millisecondsInWeek, r as toDate, s as getDefaultOptions, t as startOfWeek } from "./startOfWeek-DV5sjmzo.js";
require_react();
require_jsx_runtime();
/**
...
//#endregion
//#region node_modules/@payloadcms/ui/dist/exports/shared/index.js
var q = (e) => ({
	...e?.admin?.style || {},
	...e?.admin?.width ? { "--field-width": e.admin.width } : { flex: "1 1 auto" },
	...e?.admin?.style?.flex ? { flex: e.admin.style.flex } : {}
});
function le(e) {
	if (e) try {
		e.abort();
...
var ce = {
	...
	get: (e, t = { headers: {} }) => {
		let r = "";
		return t.params && (r = stringify(t.params, { addQueryPrefix: !0 })), fetch(`${e}${r}`, {
			credentials: "include",
			...t
		});
	},
...
function P(e) {
	...
	let a = d(e.timeZone, e), c = -(/* @__PURE__ */ new Date(+e)).getTimezoneOffset() - a, f = a !== t, k = c - l;
	if (f && k) {
		Date.prototype.setUTCMinutes.call(e, Date.prototype.getUTCMinutes.call(e) + k);
		let b = a - d(e.timeZone, e);
...
var M = ({ date: e, i18n: t, pattern: r, timezone: o }) => {
	...
	if (o) {
		let s = m.tz(o), l = transpose(n.withTimeZone(o), s);
		return t.dateFNS ? format(l, r, { locale: t.dateFNS }) : `${t.t("general:loading")}...`;
	}
	return t.dateFNS ? format(n, r, { locale: t.dateFNS }) : `${t.t("general:loading")}...`;
};
var x = (function(e) {
	return e.collection = "collections", e.global = "globals", e;
})({});
//#endregion
export { q as a, le as i, ae as n, x as o, ce as r, M as t };
