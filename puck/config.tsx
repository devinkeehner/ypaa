...
type Hero = Base & {
  ...
  registerShowWarning?: boolean;
  hotelLabel: string;
  hotelUrl: string;
  hotelAccessibleContext: string;
  hotelShowWarning?: boolean;
...
type ButtonBlockProps = Base & { label: string; url: string; accessibleContext: string; showWarning?: boolean; style: "solid" | "outline" | "text"; backgroundColor: string; textColor: string; alignment: "left" | "center" | "right" };
...
type ButtonRow = Base & { primaryLabel: string; primaryUrl: string; primaryAccessibleContext: string; primaryShowWarning?: boolean; primaryBackgroundColor: string; primaryTextColor: string; secondaryLabel: string; secondaryUrl: string; secondaryAccessibleContext: string; secondaryShowWarning?: boolean; secondaryBackgroundColor: string; secondaryTextColor: string; alignment: "left" | "center" | "right" };
...
type PayPal = Base & { label: string; url: string; accessibleContext: string; showWarning?: boolean; amount: string };
...
const warningField = (label = "Show leaving-site warning"): Field<boolean | undefined> => ({
  ...
  render: ({ value, onChange, readOnly }) => (
    <label style={{ alignItems: "center", display: "flex", gap: 8 }}>
      <input checked={value === true} disabled={readOnly} onChange={(event) => onChange(event.currentTarget.checked)} type="checkbox" />
      <span>Require confirmation before following this link</span>
    </label>
  ),
});
...
function Button({ accessibleLabel, appearance, backgroundColor, href, children, id, outline = false, showWarning, textColor }: { accessibleLabel?: string; appearance?: "solid" | "outline" | "text"; backgroundColor?: string; href: string; children: ReactNode; id?: string; outline?: boolean; showWarning?: boolean; textColor?: string }) {
...
function CampaignActions({ props }: { props: CampaignAltProps }) {
  ...
  return <div className={styles.actions}>{props.primaryLabel ? <Button accessibleLabel={actionAccessibleName(props.primaryLabel, props.primaryAccessibleContext)} backgroundColor={props.primaryButtonColor} href={props.primaryUrl || "#"} showWarning={props.primaryShowWarning} textColor={props.primaryButtonTextColor}><Editable field="primaryLabel" props={props}>{props.primaryLabel}</Editable></Button> : null}{props.secondaryLabel ? <Button accessibleLabel={actionAccessibleName(props.secondaryLabel, props.secondaryAccessibleContext)} backgroundColor={props.secondaryButtonColor} href={props.secondaryUrl || "#"} outline showWarning={props.secondaryShowWarning} textColor={props.secondaryButtonTextColor}><Editable field="secondaryLabel" props={props}>{props.secondaryLabel}</Editable></Button> : null}</div>;
}
...
function campaignAltFields(definition: CampaignAltDefinition) {
  ...
  const actions = { primaryLabel: text("Primary action label"), primaryUrl: plainText("Primary action URL"), primaryAccessibleContext: accessibleContextField(), primaryShowWarning: warningField(), primaryButtonColor: themeColorField("Primary button color"), primaryButtonTextColor: themeColorField("Primary button text"), secondaryLabel: text("Secondary action label"), secondaryUrl: plainText("Secondary action URL"), secondaryAccessibleContext: accessibleContextField(), secondaryShowWarning: warningField(), secondaryButtonColor: themeColorField("Secondary button color"), secondaryButtonTextColor: themeColorField("Secondary button text") };
...
export const puckConfig: Config<Components> = {
  ...
  components: {
            ...
            <div className={styles.shell}>
              <div className={styles.heroCopy}>
                ...
                <div className={styles.actions}>
                  <Button accessibleLabel={actionAccessibleName(props.registerLabel, props.registerAccessibleContext)} href={props.registerUrl} showWarning={props.registerShowWarning}><Editable field="registerLabel" props={props}>{props.registerLabel}</Editable></Button>
                  <Button accessibleLabel={actionAccessibleName(props.hotelLabel, props.hotelAccessibleContext)} href={props.hotelUrl} outline showWarning={props.hotelShowWarning}><Editable field="hotelLabel" props={props}>{props.hotelLabel}</Editable></Button>
                </div>
              </div>
    ...
    CallToAction: {
      ...
      defaultProps: { eyebrow: "See you there", heading: "Ready for NECYPAA?", body: "Register and reserve your room.", primaryLabel: "Register", primaryUrl: "#", primaryAccessibleContext: "", primaryShowWarning: false, secondaryLabel: "Book a hotel room", secondaryUrl: "#", secondaryAccessibleContext: "", secondaryShowWarning: false, image: null },
      fields: { eyebrow: text("Eyebrow"), heading: text("Heading"), body: area("Body"), primaryLabel: text("Primary label"), primaryUrl: plainText("Primary URL"), primaryAccessibleContext: accessibleContextField(), primaryShowWarning: warningField(), secondaryLabel: text("Secondary label"), secondaryUrl: plainText("Secondary URL"), secondaryAccessibleContext: accessibleContextField(), secondaryShowWarning: warningField(), image: mediaField("Closing artwork") },
      render: (props) => { const image = normalizeMedia(props.image); return <section className={styles.cta} data-has-image={Boolean(image)} id={props.id}>{image ? <img className={styles.ctaImage} alt={image.alt || ""} src={image.url} /> : null}<div className={styles.shell}><Editable as="p" className={styles.eyebrow} field="eyebrow" props={props}>{props.eyebrow}</Editable><Editable as="h2" field="heading" props={props}>{props.heading}</Editable><Editable as="p" className={styles.lede} field="body" props={props}>{props.body}</Editable><div className={styles.actions}><Button accessibleLabel={actionAccessibleName(props.primaryLabel, props.primaryAccessibleContext)} href={props.primaryUrl} showWarning={props.primaryShowWarning}><Editable field="primaryLabel" props={props}>{props.primaryLabel}</Editable></Button><Button accessibleLabel={actionAccessibleName(props.secondaryLabel, props.secondaryAccessibleContext)} href={props.secondaryUrl} outline showWarning={props.secondaryShowWarning}><Editable field="secondaryLabel" props={props}>{props.secondaryLabel}</Editable></Button></div></div></section>; },
    },
    Image: {
      label: "Image",
