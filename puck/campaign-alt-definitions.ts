...
const campaignAltDefinitionData = [
  ...
  { type: "AboutAlt", sourceSlug: "aboutFamily", label: "About Family Alt", kind: "profile", palette: "sections", variants: ["splitProfile", "storyStack", "checklist"] },
  ...
  { type: "PalmCardAlt", sourceSlug: "palmCardBlock", label: "Palm Card Section", kind: "cards", palette: "sections", variants: ["compactList", "splitProfile", "issueBriefs"], presentations: standardPresentations },
  ...
  { type: "CardsGridAlt", sourceSlug: "cardsGrid", label: "Cards Grid Alt", kind: "cards", palette: "sections", variants: ["imageOverlay", "infoCards", "iconCards", "editorialGrid"], presentations: standardPresentations },
  ...
  { type: "TestimonialAlt", sourceSlug: "testimonialBlock", label: "Testimonial Alt", kind: "proof", palette: "sections", variants: ["contained", "editorial", "spotlight"], presentations: standardPresentations },
