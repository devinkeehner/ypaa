...
const campaignAltDefinitionData = [
  ...
  { type: "AboutAlt", sourceSlug: "aboutFamily", label: "Bio Section", kind: "profile", palette: "sections", variants: ["splitProfile", "storyStack", "checklist"], presentations: standardPresentations },
  ...
  { type: "ProofFamilyAlt", sourceSlug: "proofFamily", label: "Proof Family Alt", kind: "proof", palette: "sections", variants: ["testimonialCards", "statsStrip", "logoCloud"], presentations: standardPresentations },
  ...
  { type: "FormBlockAlt", sourceSlug: "formBlock", label: "Form Block Alt", kind: "form", palette: "sections", variants: ["standard", "campaign", "split"], presentations: standardPresentations },
  { type: "MenuBlockAlt", sourceSlug: "menuBlock", label: "Menu Block Alt", kind: "menu", palette: "sections", variants: ["default"], presentations: standardPresentations },
  { type: "MeetingScheduleAlt", sourceSlug: "meetingSchedule", label: "Meeting Schedule Alt", kind: "schedule", palette: "sections", variants: ["default"], presentations: standardPresentations },
  { type: "ArchiveAlt", sourceSlug: "archive", label: "Archive Alt", kind: "archive", palette: "sections", variants: ["default"], presentations: standardPresentations },
  { type: "FacebookFeedAlt", sourceSlug: "facebookFeed", label: "Facebook Feed Alt", kind: "feed", palette: "sections", variants: ["cards", "mosaic", "staggered", "carousel", "flyerLightbox"], presentations: standardPresentations },
  { type: "BannerAlt", sourceSlug: "banner", label: "Banner Alt", kind: "banner", palette: "sections", variants: ["info", "warning", "error", "success"], presentations: standardPresentations },
  ...
  { type: "SimpleFormAlt", sourceSlug: "simpleFormBlock", label: "Simple Form Alt", kind: "form", palette: "sections", variants: ["default"], presentations: standardPresentations },
